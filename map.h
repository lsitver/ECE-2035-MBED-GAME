...
void add_buff1(int x, int y);
void remove_buff1(int x, int y);
void add_buff2(int x, int y);
void remove_buff2(int x, int y);

void add_debuff1(int x, int y);
void remove_debuff1(int x, int y);
void add_debuff2(int x, int y);
void remove_debuff2(int x, int y);
...
void add_present(int x, int y);
void remove_present(int x, int y);

void add_snake_body_horizontal(int x, int y);
void add_snake_body_vertical(int x, int y);
...
void remove_snake_tail_horizontal(int x, int y);
void remove_snake_tail_vertical(int x, int y);
